//! `chart-model` — a small Rust data model that **mirrors the OOXML `c:` chart
//! structure** (`research/excel-chart-data-model.md`, functional_spec §2).
//!
//! It is the **seam** of the PoC: Experiment 1 (load/save) parses chart XML *into*
//! this model, and Experiments 2/3 (render) draw *from* it. It is deliberately
//! **gpui-free and ironcalc-free** so it can be shared by every experiment and kept
//! by the follow-on ship-quality project.
//!
