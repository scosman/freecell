...
//! rest of the charts use — and the legend (in [`crate::chrome`]) keys slice→color off that
...
use chart_model::{Chart, ChartKind, SeriesData};

use crate::chrome::chart_frame;
use crate::palette::slice_color;
use crate::style::model_hsla;
...
mod tests {
    ...
    fn rejects_non_pie() {
        ...
        bar.kind = ChartKind::Bar {
            ...
            grouping: chart_model::Grouping::Clustered,
        };
