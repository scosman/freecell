...
//! - the value-axis pattern from [`crate::line`] / [`crate::area`] (one shared
...
//! - the title / both axis titles / legend from [`crate::chrome`] (the Y-axis title lives in
...
mod tests {
    use super::*;
    use chart_model::{Axis, Grouping, Legend, Series};
