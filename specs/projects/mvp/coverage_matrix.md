...
| Input-cap error shows inline message-popover text | Known-limitation | Danger **border** only; message-popover text deferred (`DECISIONS` Phase 9 post-CR). Cell unmodified + focus kept are covered. Home: [`GAPS.md`](../../../GAPS.md) (#3) |
